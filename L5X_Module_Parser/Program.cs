...
namespace L5xModuleReport
{
    ...
    *   - Now the user has to pass two arguments : the full path to the L5X file and the full path to the CSV output file.
    *
    ...
    */
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // string l5xFullPath = @"D:\C_SharpDev\PLC_Program\PLC_ProgL5X_Format.L5X";
            string l5xFullPath = args[0]; // Use the first command-line argument for the L5X file path

            // string csvFullPath = @"D:\C_SharpDev\PLC_Program\PLC_Modules_Report.csv";
            string csvFullPath = args[1]; // Use the second command-line argument for the CSV file path
